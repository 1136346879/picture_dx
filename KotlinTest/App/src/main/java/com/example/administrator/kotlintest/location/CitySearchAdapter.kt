...
*@description : 城市搜索结果
**/
class CitySearchAdapter(list: ArrayList<CityEntity.DataBean.ListBean>, context: Context) :
        BaseRvAdapter<CityEntity.DataBean.ListBean>(list, R.layout.item_city_search, context) {
