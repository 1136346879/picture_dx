...
class DividerPaddingDecoration(private val mDividerWidth: Int, color: Int, private  val padding: Int) : androidx.recyclerview.widget.RecyclerView.ItemDecoration() {
    ...
    private fun isLastColumn(parent: androidx.recyclerview.widget.RecyclerView, pos: Int, spanCount: Int,
    ...
    private fun isFirstRow(parent: androidx.recyclerview.widget.RecyclerView, pos: Int, spanCount: Int,
                           childCount: Int): Boolean {
        var childCount = childCount
        val layoutManager = parent.layoutManager
        if (layoutManager is androidx.recyclerview.widget.GridLayoutManager) {
