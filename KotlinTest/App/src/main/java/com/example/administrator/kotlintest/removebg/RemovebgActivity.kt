package com.example.administrator.kotlintest.removebg
...
import com.theapache64.removebg.BuildConfig
...
//        val uri = FileProvider.getUriForFile(this, "${BuildConfig.APPLICATION_ID}.provider", inputImage)
        val uri = FileProvider.getUriForFile(this, "com.example.baselibrary.provider", inputImage)
    ...
    private fun checkPermission(onPermissionChecked: () -> Unit) {
        ...
        val deniedListener = DialogOnDeniedPermissionListener.Builder.withContext(this)
            ...
            .withMessage("To save processed image, we need access to your external storage")
            .withButtonText("ok")
            .build()
        ...
        val permissionListener = object : BasePermissionListener() {
            ...
            override fun onPermissionDenied(response: PermissionDeniedResponse?) {
                toast("Can\\'t process image without storage permission")
            }
        }
