...
object UIUtils {
    ...
    @JvmStatic
    fun context(): Context = com.example.administrator.kotlintest.MyApplication.cxt;

    @JvmStatic
    fun resources(): Resources = com.example.administrator.kotlintest.MyApplication.resources
