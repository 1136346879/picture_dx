 ...
 * {@link Callback#onMove(RecyclerTmView, RecyclerTmView.ViewHolder, RecyclerTmView.ViewHolder)} and / or
 * {@link Callback#onSwiped(RecyclerTmView.ViewHolder, int)}.
 * <p>
 ...
 * RecyclerTmView.ViewHolder, float, float, int, boolean)}
 * or {@link Callback#onChildDrawOver(Canvas, RecyclerTmView, RecyclerTmView.ViewHolder, float, float, int,
 * boolean)}.
 * <p/>
...
public class ItemTouchHelper extends RecyclerTmView.ItemDecoration
    ...
    @SuppressWarnings("WeakerAccess") /* synthetic access */
            RecyclerTmView.ViewHolder mSelected = null;
     ...
     * {@link Callback#getAbsoluteMovementFlags(RecyclerTmView, RecyclerTmView.ViewHolder)} for the current
     * action state.
     */
    @SuppressWarnings("WeakerAccess") /* synthetic access */
    int mSelectedFlags;
    ...
    private List<RecyclerTmView.ViewHolder> mSwapTargets;
    ...
    private final RecyclerTmView.OnItemTouchListener mOnItemTouchListener = new RecyclerTmView.OnItemTouchListener() {
        @Override
        ...
        public void onTouchEvent(@NonNull RecyclerTmView recyclerTmView, @NonNull MotionEvent event) {
            ...
            RecyclerTmView.ViewHolder viewHolder = mSelected;
            if (viewHolder == null) {
                return;
            }
            switch (action) {
     ...
     */
    @SuppressWarnings("WeakerAccess") /* synthetic access */
    void select(@Nullable RecyclerTmView.ViewHolder selected, int actionState) {
        ...
        if (mSelected != null) {
            final RecyclerTmView.ViewHolder prevSelected = mSelected;
        ...
        mRecyclerTmView.post(new Runnable() {
            ...
            public void run() {
                if (mRecyclerTmView != null && mRecyclerTmView.isAttachedToWindow()
                    ...
                    // not to call onSwiped because DefaultTmItemAnimator is not good at merging
    ...
    private List<RecyclerTmView.ViewHolder> findSwapTargets(RecyclerTmView.ViewHolder viewHolder) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            final RecyclerTmView.ViewHolder otherVh = mRecyclerTmView.getChildViewHolder(other);
     ...
     */
    @SuppressWarnings("WeakerAccess") /* synthetic access */
    void moveIfNecessary(RecyclerTmView.ViewHolder viewHolder) {
        ...
        List<RecyclerTmView.ViewHolder> swapTargets = findSwapTargets(viewHolder);
        if (swapTargets.size() == 0) {
            return;
        }
        // may swap.
        RecyclerTmView.ViewHolder target = mCallback.chooseDropTarget(viewHolder, swapTargets, x, y);
        if (target == null) {
            mSwapTargets.clear();
            mDistances.clear();
            return;
    ...
    public void onChildViewDetachedFromWindow(@NonNull View view) {
        ...
        final RecyclerTmView.ViewHolder holder = mRecyclerTmView.getChildViewHolder(view);
        if (holder == null) {
            return;
        }
     ...
     */
    @SuppressWarnings("WeakerAccess") /* synthetic access */
    void endRecoverAnimation(RecyclerTmView.ViewHolder viewHolder, boolean override) {
        final int recoverAnimSize = mRecoverAnimations.size();
        for (int i = recoverAnimSize - 1; i >= 0; i--) {
    ...
    private RecyclerTmView.ViewHolder findSwipedView(MotionEvent motionEvent) {
        final RecyclerTmView.LayoutManager lm = mRecyclerTmView.getLayoutManager();
        if (mActivePointerId == ACTIVE_POINTER_ID_NONE) {
            return null;
        }
    ...
    void checkSelectForSwipe(int action, MotionEvent motionEvent, int pointerIndex) {
        ...
        final RecyclerTmView.ViewHolder vh = findSwipedView(motionEvent);
        if (vh == null) {
            return;
        }
     ...
     */
    public void startDrag(@NonNull RecyclerTmView.ViewHolder viewHolder) {
     ...
     *                   RecyclerView.
     */
    public void startSwipe(@NonNull RecyclerTmView.ViewHolder viewHolder) {
    ...
    private int swipeIfNecessary(RecyclerTmView.ViewHolder viewHolder) {
        if (mActionState == ACTION_STATE_DRAG) {
            return 0;
        }
    ...
    public int checkHorizontalSwipe(RecyclerTmView.ViewHolder viewHolder, int flags) {
    ...
    private int checkVerticalSwipe(RecyclerTmView.ViewHolder viewHolder, int flags) {
        if ((flags & (UP | DOWN)) != 0) {
     ...
     * {@link #getMovementFlags(RecyclerTmView, RecyclerTmView.ViewHolder)} and return appropriate set
     ...
     * {@link Callback#onMove(RecyclerTmView, RecyclerTmView.ViewHolder, RecyclerTmView.ViewHolder)
     ...
     * {@link #canDropOver(RecyclerTmView, RecyclerTmView.ViewHolder, RecyclerTmView.ViewHolder)}. When a
     ...
     * {@link #chooseDropTarget(RecyclerTmView.ViewHolder, java.util.List, int, int)} to select a
     * custom drop target.
     * <p>
     * When a View is swiped, ItemTouchHelper animates it until it goes out of bounds, then calls
     * {@link #onSwiped(RecyclerTmView.ViewHolder, int)}. At this point, you should update your
    ...
    public abstract static class Callback {
        ...
        public abstract int getMovementFlags(@NonNull RecyclerTmView recyclerTmView,
                @NonNull RecyclerTmView.ViewHolder viewHolder);
        ...
        final int getAbsoluteMovementFlags(RecyclerTmView recyclerTmView,
                                           RecyclerTmView.ViewHolder viewHolder) {
        ...
        boolean hasDragFlag(RecyclerTmView recyclerTmView, RecyclerTmView.ViewHolder viewHolder) {
         ...
         * passed to {@link #chooseDropTarget(RecyclerTmView.ViewHolder, java.util.List, int, int)}.
         * <p>
         ...
         */
        @SuppressWarnings("WeakerAccess")
        public boolean canDropOver(@NonNull RecyclerTmView recyclerTmView, @NonNull RecyclerTmView.ViewHolder current,
                                   @NonNull RecyclerTmView.ViewHolder target) {
            return true;
        }
         ...
         * ({@link RecyclerTmView.ViewHolder#getAdapterPosition()
         ...
         * {@code target}.
         * @see #onMoved(RecyclerTmView, RecyclerTmView.ViewHolder, int, RecyclerTmView.ViewHolder, int, int, int)
         */
        public abstract boolean onMove(@NonNull RecyclerTmView recyclerTmView,
                                       @NonNull RecyclerTmView.ViewHolder viewHolder, @NonNull RecyclerTmView.ViewHolder target);
         ...
         * dragging on a custom view touch using {@link #startDrag(RecyclerTmView.ViewHolder)}.
         *
         ...
         * @see #startDrag(RecyclerTmView.ViewHolder)
         */
         ...
         * <p>
         * Default value returns true but you may want to disable this if you want to start
         * swiping on a custom view touch using {@link #startSwipe(RecyclerTmView.ViewHolder)}.
         *
         * @return True if ItemTouchHelper should start swiping an item when user swipes a pointer
         * over the View, false otherwise. Default value is <code>true</code>.
         * @see #startSwipe(RecyclerTmView.ViewHolder)
         */
         ...
         */
        @SuppressWarnings("WeakerAccess")
        public float getSwipeThreshold(@NonNull RecyclerTmView.ViewHolder viewHolder) {
            return .5f;
        }
         ...
         */
        @SuppressWarnings("WeakerAccess")
        public float getMoveThreshold(@NonNull RecyclerTmView.ViewHolder viewHolder) {
            return .5f;
        }
         ...
         * @see #getSwipeThreshold(RecyclerTmView.ViewHolder)
         */
        @SuppressWarnings("WeakerAccess")
         ...
         */
        @SuppressWarnings("WeakerAccess")
        public RecyclerTmView.ViewHolder chooseDropTarget(@NonNull RecyclerTmView.ViewHolder selected,
                                                          @NonNull List<RecyclerTmView.ViewHolder> dropTargets, int curX, int curY) {
            int right = curX + selected.itemView.getWidth();
            int bottom = curY + selected.itemView.getHeight();
            RecyclerTmView.ViewHolder winner = null;
            int winnerScore = -1;
            final int dx = curX - selected.itemView.getLeft();
            final int dy = curY - selected.itemView.getTop();
            final int targetsSize = dropTargets.size();
            for (int i = 0; i < targetsSize; i++) {
                final RecyclerTmView.ViewHolder target = dropTargets.get(i);
                if (dx > 0) {
         ...
         * {@link #getMovementFlags(RecyclerTmView, RecyclerTmView.ViewHolder)} method, this method
         ...
         * {@link #clearView(RecyclerTmView, RecyclerTmView.ViewHolder)}.
         *
         * @param viewHolder The ViewHolder which has been swiped by the user.
         * @param direction  The direction to which the ViewHolder is swiped. It is one of
         *                   {@link #UP}, {@link #DOWN},
         *                   {@link #LEFT} or {@link #RIGHT}. If your
         *                   {@link #getMovementFlags(RecyclerTmView, RecyclerTmView.ViewHolder)}
         *                   method
         *                   returned relative flags instead of {@link #LEFT} / {@link #RIGHT};
         *                   `direction` will be relative as well. ({@link #START} or {@link
         *                   #END}).
         */
        public abstract void onSwiped(@NonNull RecyclerTmView.ViewHolder viewHolder, int direction);
         ...
         */
        public void onSelectedChanged(@Nullable RecyclerTmView.ViewHolder viewHolder, int actionState) {
            if (viewHolder != null) {
        ...
        /**
         * Called when {@link #onMove(RecyclerTmView, RecyclerTmView.ViewHolder, RecyclerTmView.ViewHolder)} returns true.
         * <p>
        ...
        public void onMoved(@NonNull final RecyclerTmView recyclerTmView,
                            @NonNull final RecyclerTmView.ViewHolder viewHolder, int fromPos, @NonNull final RecyclerTmView.ViewHolder target,
        ...
        void onDraw(Canvas c, RecyclerTmView parent, RecyclerTmView.ViewHolder selected,
        ...
        void onDrawOver(Canvas c, RecyclerTmView parent, RecyclerTmView.ViewHolder selected,
                        List<ItemTouchHelper.RecoverAnimation> recoverAnimationList,
                        int actionState, float dX, float dY) {
            final int recoverAnimSize = recoverAnimationList.size();
            for (int i = 0; i < recoverAnimSize; i++) {
         ...
         * {@link #onChildDraw(Canvas, RecyclerTmView, RecyclerTmView.ViewHolder, float, float, int,
         * boolean)} or
         * {@link #onChildDrawOver(Canvas, RecyclerTmView, RecyclerTmView.ViewHolder, float, float, int, boolean)}.
         *
         * @param recyclerTmView The RecyclerView which is controlled by the ItemTouchHelper.
         * @param viewHolder   The View that was interacted by the user.
         */
        public void clearView(@NonNull RecyclerTmView recyclerTmView, @NonNull RecyclerTmView.ViewHolder viewHolder) {
         ...
         * @see #onChildDrawOver(Canvas, RecyclerTmView, RecyclerTmView.ViewHolder, float, float, int,
         * boolean)
         */
    ...
    public abstract static class SimpleCallback extends Callback {
         ...
         * {@link #getSwipeDirs(RecyclerTmView, RecyclerTmView.ViewHolder)}
         * and / or {@link #getDragDirs(RecyclerTmView, RecyclerTmView.ViewHolder)}.
         *
        ...
        public int getSwipeDirs(@SuppressWarnings("unused") @NonNull RecyclerTmView recyclerTmView,
                @NonNull @SuppressWarnings("unused") RecyclerTmView.ViewHolder viewHolder) {
        ...
        public int getDragDirs(@SuppressWarnings("unused") @NonNull RecyclerTmView recyclerTmView,
                @SuppressWarnings("unused") @NonNull RecyclerTmView.ViewHolder viewHolder) {
    ...
    private class ItemTouchHelperGestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public void onLongPress(MotionEvent e) {
            ...
            if (child != null) {
                RecyclerTmView.ViewHolder vh = mRecyclerTmView.getChildViewHolder(child);
                if (vh != null) {
    ...
    private static class RecoverAnimation implements Animator.AnimatorListener {
        ...
        final RecyclerTmView.ViewHolder mViewHolder;
        ...
        RecoverAnimation(RecyclerTmView.ViewHolder viewHolder, int animationType,
