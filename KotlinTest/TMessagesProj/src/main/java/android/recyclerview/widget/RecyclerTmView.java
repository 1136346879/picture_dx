...
import android.recyclerview.widget.RecyclerTmView.ItemAnimator.ItemHolderInfo;
...
public class RecyclerTmView extends ViewGroup implements ScrollingView,
    ...
    ItemAnimator mItemAnimator = new DefaultTmItemAnimator();
     ...
     * uses an instance of {@link DefaultTmItemAnimator}. Whether item animations are
     ...
     * uses an instance of {@link DefaultTmItemAnimator}.
     *
    ...
    public final class Recycler {
        ...
        public void recycleView(@NonNull View view) {
            ...
            // the "pending moving" list of DefaultTmItemAnimator and DefaultTmItemAnimator later in
    ...
    public abstract static class LayoutManager {
         ...
         * way. For example, the default ItemAnimator, {@link DefaultTmItemAnimator}, will
     ...
     *
     * <p>By default, RecyclerView uses {@link DefaultTmItemAnimator}.</p>
     *
    ...
    public abstract static class ItemAnimator {
         ...
         * adapter. {@link DefaultTmItemAnimator} will skip animating the View if its location on the
         ...
         * to cross-fade the old and the new one ({@link DefaultTmItemAnimator} uses this technique).
         * <p>
