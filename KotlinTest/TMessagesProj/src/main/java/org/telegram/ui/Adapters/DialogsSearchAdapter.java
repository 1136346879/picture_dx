...
public class DialogsSearchAdapter extends RecyclerTmListView.SelectionAdapter {
    ...
    private class CategoryAdapterRecycler extends RecyclerTmListView.SelectionAdapter {
    ...
    public RecyclerTmListView getInnerListView() {
    ...
    public RecyclerTmView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case 4:
                ...
                break;
            case 5:
                RecyclerTmListView horizontalListView = new RecyclerTmListView(mContext) {
                    @Override
    ...
    public void onBindViewHolder(RecyclerTmView.ViewHolder holder, int position) {
        switch (holder.getItemViewType()) {
            ...
            case 5: {
                RecyclerTmListView recyclerListView = (RecyclerTmListView) holder.itemView;
