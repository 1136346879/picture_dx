...
public class MediaActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        for (int a = 0; a < mediaPages.length; a++) {
            if (a == 0) {
                if (mediaPages[a] != null && mediaPages[a].layoutManager != null) {
                    ...
                    if (scrollToPositionOnRecreate != mediaPages[a].layoutManager.getItemCount() - 1) {
                        RecyclerTmListView.Holder holder = (RecyclerTmListView.Holder) mediaPages[a].listView.findViewHolderForAdapterPosition(scrollToPositionOnRecreate);
                        if (holder != null) {
            ...
            mediaPages[a].listView = new RecyclerTmListView(context) {
                @Override
    ...
    public void didReceivedNotification(int id, int account, Object... args) {
        if (id == NotificationCenter.mediaDidLoad) {
            ...
            if (guid == classGuid) {
                ...
                RecyclerTmListView.Adapter adapter = null;
                if (type == 0) {
                ...
                if (adapter != null) {
                    ...
                    if (adapter instanceof RecyclerTmListView.SectionsAdapter) {
                        RecyclerTmListView.SectionsAdapter sectionsAdapter = (RecyclerTmListView.SectionsAdapter) adapter;
    ...
    private class SharedLinksAdapter extends RecyclerTmListView.SectionsAdapter {
    ...
    private class SharedDocumentsAdapter extends RecyclerTmListView.SectionsAdapter {
    ...
    private class SharedPhotoVideoAdapter extends RecyclerTmListView.SectionsAdapter {
    ...
    public class MediaSearchAdapter extends RecyclerTmListView.SelectionAdapter {
