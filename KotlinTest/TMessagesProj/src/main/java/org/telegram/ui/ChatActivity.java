...
import android.recyclerview.widget.LinearSmoothScrollerMiddle;
...
import android.recyclerview.widget.GridLayoutManagerFixed;
...
public class ChatActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, DialogsActivity.DialogsActivityDelegate, LocationActivity.LocationActivityDelegate {
    ...
    private RecyclerTmListView chatListView;
    ...
    private RecyclerTmListView stickersListView;
    private ImageView stickersPanelArrow;
    private RecyclerTmListView.OnItemClickListener stickersOnItemClickListener;
    private RecyclerTmListView.OnItemClickListener mentionsOnItemClickListener;
    ...
    private RecyclerTmListView mentionListView;
    ...
    RecyclerTmListView.OnItemLongClickListenerExtended onItemLongClickListener = new RecyclerTmListView.OnItemLongClickListenerExtended() {
        @Override
    ...
    RecyclerTmListView.OnItemClickListenerExtended onItemClickListener = new RecyclerTmListView.OnItemClickListenerExtended() {
        @Override
    ...
    public View createView(Context context) {
        ...
        chatListView = new RecyclerTmListView(context) {
        ...
        mentionListView = new RecyclerTmListView(context) {
        ...
        mentionListView.setOverScrollMode(RecyclerTmListView.OVER_SCROLL_NEVER);
        ...
        stickersListView = new RecyclerTmListView(context) {
            @Override
            public boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        stickersListView.setOverScrollMode(RecyclerTmListView.OVER_SCROLL_NEVER);
    ...
    private void mentionListViewUpdateLayout() {
        ...
        RecyclerTmListView.Holder holder = (RecyclerTmListView.Holder) mentionListView.findContainingViewHolder(child);
        if (mentionLayoutManager.getReverseLayout()) {
            if (holder != null) {
            ...
            holder = (RecyclerTmListView.Holder) mentionListView.findContainingViewHolder(child);
    ...
    private void checkAutoDownloadMessages(boolean scrollUp) {
        ...
        for (int a = 0; a < count; a++) {
            ...
            RecyclerTmListView.ViewHolder holder = chatListView.findContainingViewHolder(child);
            if (holder != null) {
                int p = holder.getAdapterPosition();
        ...
        if (id == NotificationCenter.messagesDidLoad) {
            ...
            if (chatLayoutManager != null) {
                ...
                if (lastPosition != 0) {
                    ...
                    RecyclerTmListView.Holder holder = (RecyclerTmListView.Holder) chatListView.findViewHolderForAdapterPosition(scrollToPositionOnRecreate);
                    if (holder != null) {
        ...
        if (!inScheduleMode) {
            ...
            if (!pausedOnLastMessage) {
                ...
                if (chatLayoutManager != null) {
                    ...
                    if (position != 0) {
                        RecyclerTmListView.Holder holder = (RecyclerTmListView.Holder) chatListView.findViewHolderForAdapterPosition(position);
                        if (holder != null) {
                            int mid = 0;
                            if (holder.itemView instanceof ChatMessageCell) {
                            ...
                            if (mid == 0) {
                                holder = (RecyclerTmListView.Holder) chatListView.findViewHolderForAdapterPosition(position + 1);
                            }
    ...
    public class ChatActivityAdapter extends RecyclerTmView.Adapter {
        ...
        public long getItemId(int i) {
            return RecyclerTmListView.NO_ID;
        }
