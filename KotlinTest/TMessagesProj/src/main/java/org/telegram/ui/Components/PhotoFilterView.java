...
public class PhotoFilterView extends FrameLayout {
    ...
    private RecyclerTmListView recyclerListView;
    ...
    public PhotoFilterView(Context context, Bitmap bitmap, int rotation, MediaController.SavedFilterState state) {
        ...
        recyclerListView = new RecyclerTmListView(context);
        ...
        recyclerListView.setOverScrollMode(RecyclerTmListView.OVER_SCROLL_NEVER);
    ...
    public class ToolsAdapter extends RecyclerTmListView.SelectionAdapter {
