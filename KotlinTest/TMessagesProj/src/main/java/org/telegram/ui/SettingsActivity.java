...
public class SettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, ImageUpdater.ImageUpdaterDelegate {
    ...
    public View createView(Context context) {
        ...
        listView.setOnItemLongClickListener(new RecyclerTmListView.OnItemLongClickListener() {
            ...
            private void open() {
                ...
                if (rowName != null) {
                    ...
                    try {
                        ...
                        RecyclerTmListView.IntReturnCallback callback = () -> {
                            int position = -1;
                            try {
                        ...
                        RecyclerTmListView listView = (RecyclerTmListView) listViewField.get(openingFragment);
