...
public class EmojiView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    private RecyclerTmListView emojiGridView;
    ...
    private RecyclerTmListView gifGridView;
    private ExtendedGridLayoutManager gifLayoutManager;
    private GifSearchAdapter gifSearchAdapter;
    private RecyclerTmListView.OnItemClickListener gifOnItemClickListener;
    ...
    private RecyclerTmListView trendingGridView;
    ...
    public EmojiView(boolean needStickers, boolean needGif, final Context context, boolean needSearch, final TLRPC.ChatFull chatFull) {
        ...
        emojiGridView = new RecyclerTmListView(context) {
        ...
        emojiGridView.setOnItemClickListener(new RecyclerTmListView.OnItemClickListener() {
            @Override
        ...
        emojiGridView.setOnItemLongClickListener(new RecyclerTmListView.OnItemLongClickListener() {
            @Override
            public boolean onItemClick(View view, int position) {
                if (view instanceof ImageViewEmoji) {
                    ...
                    if (EmojiData.emojiColoredMap.containsKey(toCheck)) {
                        ...
                        RecyclerTmListView.ViewHolder holder = emojiGridView.findContainingViewHolder(view);
        ...
        if (needStickers) {
            if (needGif) {
                ...
                gifGridView = new RecyclerTmListView(context) {
                ...
                gifGridView.setOverScrollMode(RecyclerTmListView.OVER_SCROLL_NEVER);
            ...
            trendingGridView = new RecyclerTmListView(context);
    ...
    private void updateVisibleTrendingSets() {
        ...
        try {
            for (int b = 0; b < 2; b++) {
                RecyclerTmListView gridView = b == 0 ? trendingGridView : stickersGridView;
                int count = gridView.getChildCount();
                for (int a = 0; a < count; a++) {
                    View child = gridView.getChildAt(a);
                    if (child instanceof FeaturedStickerSetInfoCell) {
                        RecyclerTmListView.Holder holder = (RecyclerTmListView.Holder) gridView.getChildViewHolder(child);
                        if (holder == null) {
                            continue;
                        }
    ...
    private class TrendingGridAdapter extends RecyclerTmListView.SelectionAdapter {
    ...
    private class EmojiGridAdapter extends RecyclerTmListView.SelectionAdapter {
    ...
    private class EmojiSearchAdapter extends RecyclerTmListView.SelectionAdapter {
    ...
    private class GifAdapter extends RecyclerTmListView.SelectionAdapter {
    ...
    private class GifSearchAdapter extends RecyclerTmListView.SelectionAdapter {
    ...
    private class StickersSearchGridAdapter extends RecyclerTmListView.SelectionAdapter {
