    ...
    public View createView(Context context) {
        ...
        listView.setOnItemClickListener((view, position) -> {
            if (position == useProxyRow) {
                ...
                if (!useProxySettings) {
                    RecyclerTmListView.Holder holder = (RecyclerTmListView.Holder) listView.findViewHolderForAdapterPosition(callsRow);
                    if (holder != null) {
                ...
                updateRows(false);
                RecyclerTmListView.Holder holder = (RecyclerTmListView.Holder) listView.findViewHolderForAdapterPosition(useProxyRow);
                if (holder != null) {
        ...
        if (id == NotificationCenter.proxySettingsChanged) {
            ...
            if (currentConnectionState != state) {
                ...
                if (listView != null && SharedConfig.currentProxy != null) {
                    ...
                    if (idx >= 0) {
                        RecyclerTmListView.Holder holder = (RecyclerTmListView.Holder) listView.findViewHolderForAdapterPosition(idx + proxyStartRow);
                        if (holder != null) {
                            TextDetailProxyCell cell = (TextDetailProxyCell) holder.itemView;
                            cell.updateStatus();
                        }
