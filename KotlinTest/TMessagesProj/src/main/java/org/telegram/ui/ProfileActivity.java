...
public class ProfileActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, DialogsActivity.DialogsActivityDelegate {
        ...
        listView.setOnItemClickListener((view, position, x, y) -> {
            ...
            if (position == photosRow || position == filesRow || position == linksRow || position == audioRow || position == voiceRow) {
                ...
                if (LocaleController.isRTL && x <= AndroidUtilities.dp(76) || !LocaleController.isRTL && x >= view.getMeasuredWidth() - AndroidUtilities.dp(76)) {
                    ...
                    RecyclerTmListView.Holder holder = (RecyclerTmListView.Holder) listView.findViewHolderForPosition(notificationsRow);
                    if (holder != null) {
    ...
    private void checkListViewScroll() {
        ...
        RecyclerTmListView.Holder holder = (RecyclerTmListView.Holder) listView.findContainingViewHolder(child);
        ...
        if (id == NotificationCenter.updateInterfaces) {
            ...
            if (user_id != 0) {
                ...
                if ((mask & MessagesController.UPDATE_MASK_PHONE) != 0) {
                    if (listView != null) {
                        RecyclerTmListView.Holder holder = (RecyclerTmListView.Holder) listView.findViewHolderForPosition(phoneRow);
                        if (holder != null) {
