...
public class ProfileNotificationsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(final Context context) {
        ...
        listView.setOnItemClickListener(new RecyclerTmListView.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                if (position == customRow && view instanceof TextCheckBoxCell) {
                    ...
                    if (position == soundRow) {
                        ...
                        RecyclerTmListView list = new RecyclerTmListView(getParentActivity());
                        list.setLayoutManager(new LinearLayoutTmManager(context, LinearLayoutTmManager.VERTICAL, false));
                        list.setClipToPadding(true);
                        list.setAdapter(new RecyclerTmListView.SelectionAdapter() {
                            @Override
                            ...
                            public RecyclerTmView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                                ...
                                return new RecyclerTmListView.Holder(textView);
                            }
    ...
    private void checkRowsEnabled() {
        ...
        for (int a = 0; a < count; a++) {
            ...
            RecyclerTmListView.Holder holder = (RecyclerTmListView.Holder) listView.getChildViewHolder(child);
