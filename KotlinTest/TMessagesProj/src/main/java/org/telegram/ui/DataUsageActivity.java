...
public class DataUsageActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        for (int a = 0; a < viewPages.length; a++) {
            if (a == 0) {
                if (viewPages[a] != null && viewPages[a].layoutManager != null) {
                    ...
                    if (scrollToPositionOnRecreate != viewPages[a].layoutManager.getItemCount() - 1) {
                        RecyclerTmListView.Holder holder = (RecyclerTmListView.Holder) viewPages[a].listView.findViewHolderForAdapterPosition(scrollToPositionOnRecreate);
                        if (holder != null) {
            ...
            RecyclerTmListView listView = new RecyclerTmListView(context);
