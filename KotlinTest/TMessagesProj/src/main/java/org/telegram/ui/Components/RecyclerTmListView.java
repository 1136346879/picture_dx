...
public class RecyclerTmListView extends RecyclerTmView {
    ...
    private class RecyclerListViewItemClickListener implements OnItemTouchListener {
        ...
        public boolean onInterceptTouchEvent(RecyclerTmView view, MotionEvent event) {
            ...
            boolean isScrollIdle = RecyclerTmListView.this.getScrollState() == RecyclerTmListView.SCROLL_STATE_IDLE;
    ...
    public RecyclerTmListView(Context context) {
        super(context);
    ...
    public void highlightRow(RecyclerTmListView.IntReturnCallback callback) {
        highlightRowInternal(callback, true);
    }

    private void highlightRowInternal(RecyclerTmListView.IntReturnCallback callback, boolean canHighlightLater) {
        if (removeHighlighSelectionRunnable != null) {
