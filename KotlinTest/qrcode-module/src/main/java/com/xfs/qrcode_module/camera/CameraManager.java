...
import com.xfs.qrcode_module.camera.open.OpenCamera;
import com.xfs.qrcode_module.camera.open.OpenCameraInterface;
...
//            camera.getCamera().release();
    ...
    public synchronized Rect getFramingRect() {
        if (framingRect == null) {
            ...
            int height = findDesiredDimensionInRange(screenResolution.x, MIN_FRAME_HEIGHT, MAX_FRAME_WIDTH);
