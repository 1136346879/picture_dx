...
public final class NetworkUtil {
    ...
    public static void openWirelessSettings() {
        Util.getApp().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        return ((ConnectivityManager) Util.getApp().getSystemService(Context.CONNECTIVITY_SERVICE)).getActiveNetworkInfo();
    }
...
//    }
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager wifiManager = (WifiManager) Util.getApp().getSystemService(Context.WIFI_SERVICE);
