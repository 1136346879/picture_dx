 ...
 * 空页面 Loading 时页面展示
 */
public class LoadingRecycleViewView extends RelativeLayout implements View.OnClickListener {
    ...
    public LoadingRecycleViewView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
