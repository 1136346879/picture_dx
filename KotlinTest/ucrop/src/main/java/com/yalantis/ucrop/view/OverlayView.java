...
public class OverlayView extends View {
...

    {
        ...
        mCropRectCornerTouchAreaLineLength = getResources().getDimensionPixelSize(R.dimen.ucrop_default_crop_rect_corner_touch_threshold);
    }
...
//        }
    ...
    private void initCropFrameStyle(@NonNull TypedArray a) {
        ...
        int cropFrameColor = a.getColor(R.styleable.ucrop_UCropView_ucrop_frame_color,
                getResources().getColor(R.color.ucrop_color_toolbar));
